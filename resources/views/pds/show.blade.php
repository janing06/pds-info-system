                            ...
                            <ul class="nav nav-tabs nav-fill flex-column">
                                <li class="nav-item mb-2">
                                    <a class="nav-link mb-sm-3 mb-md-0 active" data-bs-toggle="tab"
                                        href="#personal_information"><i class="bi bi-person-circle me-2"></i>
                                        Personal
                                        Info</a>
                                </li>
                                <li class="nav-item mb-2">
                                    <a class="nav-link mb-sm-3 mb-md-0" data-bs-toggle="tab"
                                        href="#family_background"><i class="bi bi-person-bounding-box me-2"></i>
                                        Family
                                        Background</a>
                                </li>
                                <li class="nav-item mb-2">
                                    ...
                                    <form class="mt-5" method="POST" action="{{ route('pds.update', $pds) }}">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select name="suffix" id="suffix"
                                                        ...
                                                        <option value="N/A"
                                                            {{ $pds->suffix == 'N/A' ? 'selected' : '' }}>
                                                            N/A</option>
                                                        <option value="JR"
                                                            {{ $pds->suffix == 'JR' ? 'selected' : '' }}>
                                                            JR
                                                        </option>
                                                        <option value="SR"
                                                            {{ $pds->suffix == 'SR' ? 'selected' : '' }}>
                                                            SR
                                                        </option>
                                                        <option value="II"
                                                            {{ $pds->suffix == 'II' ? 'selected' : '' }}>II
                                                        </option>
                                                        <option value="III"
                                                            {{ $pds->suffix == 'III' ? 'selected' : '' }}>
                                                            III</option>
                                                        <option value="IV"
                                                            {{ $pds->suffix == 'IV' ? 'selected' : '' }}>IV
                                                        </option>
                                                    </select>
                                                    @error('suffix')
                                                        <x-input-error message="{{ $message }}" />
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select name="sex" id="sex"
                                                        ...
                                                        <option value="male"
                                                            {{ $pds->sex == 'male' ? 'selected' : '' }}>
                                                            Male</option>
                                                        <option value="female"
                                                            {{ $pds->sex == 'female' ? 'selected' : '' }}>
                                                            Female
                                                        </option>
                                                    </select>
                                                    @error('sex')
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select name="civil_status" id="civil_status"
                                                        ...
                                                        <option value="separated"
                                                            {{ $pds->civil_status == 'separated' ? 'selected' : '' }}>
                                                            Separated
                                                        </option>
                                                    </select>
                                                    @error('civil_status')
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-lg-5">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" id="residential_city"
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" id="residential_street"
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" id="residential_zipcode"
                                            ...
                                            <div class="col-lg-5">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" id="permanent_province"
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" id="permanent_barangay"
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" id="permanent_street"
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" id="permanent_house_no"
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" id="permanent_zipcode"
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <a href="{{ route('pds.index') }}"
                                                class="btn btn-gray-800 mt-2 animate-up-2"><i
                                    ...
                                    <form class="mt-5" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" id="spouse_middle_name"
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" id="spouse_business_name"
                                                    name="spouse_business_name"
                                        ...
                                        <div class="row mb-5">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" id="spouse_telephone_no"
