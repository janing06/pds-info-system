<div id="personal_information" class="tab-pane fade show active">
    ...
    <p class="text-center">Here you can view and edit profile information.</p>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group mb-3">
                    ...
                    <select name="suffix" id="suffix" class="form-select @error('suffix') is-invalid @enderror">
                        <option value="N/A" {{ $pds->suffix == 'N/A' ? 'selected' : '' }}>
                            N/A</option>
                        <option value="JR" {{ $pds->suffix == 'JR' ? 'selected' : '' }}>
                            JR
                        </option>
                        <option value="SR" {{ $pds->suffix == 'SR' ? 'selected' : '' }}>
                            SR
                        </option>
            ...
            <div class="col-md-4">
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="place_of_birth" name="place_of_birth"
                        ...
                        value="{{ old('place_of_birth', $pds->place_of_birth) }}" placeholder="Place of birth">
            ...
            <div class="col-md-4">
                <div class="form-group mb-3">
                    ...
                    <select name="civil_status" id="civil_status"
                        ...
                        <option value="">Select Option</option>
                        <option value="single" {{ $pds->civil_status == 'single' ? 'selected' : '' }}>
                            Single</option>
                        <option value="married" {{ $pds->civil_status == 'married' ? 'selected' : '' }}>
                            Married</option>
                        <option value="widowed" {{ $pds->civil_status == 'widowed' ? 'selected' : '' }}>
                            Widowed</option>
            ...
            <div class="col-md-4">
                <div class="form-group mb-3">
                    ...
                    <input type="number" id="height" name="height"
                        ...
                        value="{{ old('height', $pds->height) }}" placeholder="Height in meters" step="0.01">
                    @error('height')
                        <x-input-error message="{{ $message }}" />
                    @enderror
                </div>
            ...
            <div class="col-md-4">
                <div class="form-group mb-3">
                    ...
                    <input type="number" id="weight" name="weight"
                        ...
                        value="{{ old('weight', $pds->weight) }}" placeholder="Weight in meters" step="0.01">
                    @error('weight')
                        <x-input-error message="{{ $message }}" />
                    @enderror
                </div>
            ...
            <div class="col-md-4">
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="blood_type" name="blood_type"
                        ...
                        value="{{ old('blood_type', $pds->blood_type) }}" placeholder="Blood Type">
                    @error('blood_type')
                        <x-input-error message="{{ $message }}" />
                    @enderror
                </div>
            ...
            <div class="col-md-4">
                <div class="form-group mb-3">
                    ...
                    <select name="citizenship" id="citizenship"
                        ...
                        <option value="">Select Option</option>
                        <option value="filipino" {{ $pds->citizenship == 'filipino' ? 'selected' : '' }}>
                            Filipino</option>
            ...
            <div class="col-md-4">
                <div class="form-group mb-3">
                    ...
                    <input type="number" id="telephone_no" name="telephone_no"
                        ...
                        value="{{ old('telephone_no', $pds->telephone_no) }}" placeholder="Telephone no">
                    @error('country')
                        <x-input-error message="{{ $message }}" />
                    @enderror
                </div>
            ...
            <div class="col-md-4">
                <div class="form-group mb-3">
                    ...
                    <input type="number" id="mobile_no" name="mobile_no"
                        ...
                        value="{{ old('mobile_no', $pds->mobile_no) }}" placeholder="Mobile No">
                    @error('mobile_no')
                        <x-input-error message="{{ $message }}" />
                    @enderror
                </div>
            ...
            <div class="col-lg-5">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="residential_city" name="residential_city"
                        ...
                        value="{{ old('residential_city', $pds->residentialAddress->city) }}" placeholder="City">
            ...
            <div class="col-lg-5">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="permanent_city" name="permanent_city"
                        ...
                        value="{{ old('permanent_city', $pds->permanentAddress->city) }}" placeholder="City">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="permanent_street" name="permanent_street"
                        ...
                        value="{{ old('permanent_street', $pds->permanentAddress->street) }}" placeholder="Street">
            ...
            <div class="col-xl-3">
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="pag_ibig_id" name="pag_ibig_id"
                        ...
                        value="{{ old('pag_ibig_id', $pds->pag_ibig_id) }}" placeholder="Pag-ibig No">
                    @error('pag_ibig_id')
                        <x-input-error message="{{ $message }}" />
                    @enderror
                </div>
            ...
            <div class="col-xl-3">
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="philhealth_id" name="philhealth_id"
                        ...
                        value="{{ old('philhealth_id', $pds->philhealth_id) }}" placeholder="PhilHealth No">
                    @error('philhealth_id')
                        <x-input-error message="{{ $message }}" />
                    @enderror
                </div>
